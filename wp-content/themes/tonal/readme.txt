...
= 1.0.4 - May 12, 2014
* Fixed issue where text color could become illegible if a valid background color isn't set.
* Ensure categories are properly displayed on posts.
* Add support for Jetpack Responsive Videos.

= 1.0.2 - April 16, 2014 - Fixed issue where categories did not show up properly on single view.
