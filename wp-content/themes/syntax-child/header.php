	...
	<header id="masthead" class="site-header" role="banner">
		...
		<div class="site-header-wrapper">
			...
			<div class="site-branding" style="display:inline">
						<a class="site-logo-link-dl" href="http://datalook.io" style="vertical-align:middle">
							 <svg class="logo-dl" width="161" height="24">
									<image xlink:href="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/themes/syntax-child/images/logo-datalook.svg" src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/themes/syntax/images/logo.jpg" width="161" height="24"/>
							</svg>
						</a>
					  <h1 class="site-title-dl">
							<?php bloginfo( 'name' ); ?>
						</h1>
			</div>
